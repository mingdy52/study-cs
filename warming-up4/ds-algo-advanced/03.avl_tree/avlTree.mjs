...
class AVLTree{
    ...
    getBalanceFactor(node){
        let leftChildNodeHeight = this.getHeight(node.getLeftSubTree());
        let rightChildNodeHeight = this.getHeight(node.getRightSubTree());
       
        return leftChildNodeHeight - rightChildNodeHeight;
    }
    ...
    // targetNode: 회전시킬 노드 / data: 균형을 무너트린 원인
    ...
    // targetNode: 해당 노드 / unBalanceNode: 균형을 무너트리는 노드
